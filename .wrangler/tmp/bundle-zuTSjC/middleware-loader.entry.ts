...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/home/user/pjs/gpt_hono/cloudflare-workshop-examples/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/home/user/pjs/gpt_hono/cloudflare-workshop-examples/projects/chatgpt-plugin/.wrangler/tmp/bundle-zuTSjC/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/home/user/pjs/gpt_hono/cloudflare-workshop-examples/projects/chatgpt-plugin/.wrangler/tmp/bundle-zuTSjC/middleware-insertion-facade.js";
